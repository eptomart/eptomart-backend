...
// Placeholder shown for all products until real photos are uploaded via admin
const COMING_SOON = 'https://placehold.co/600x400/fff7ed/ea580c?text=Image+Coming+Soon';
  ...
  for (const p of PRODUCTS) {
    try {
      ...
      await Product.create({
        ...
        images: [{ url: COMING_SOON, isDefault: true }],
