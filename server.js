...
const expressPOSRoutes      = require('./src/routes/expressPOS'); // Eptomart Express — Phase 5: POS billing terminal
...
app.use('/api/express/pos',     expressPOSRoutes); // Eptomart Express — Phase 5 POS billing API
