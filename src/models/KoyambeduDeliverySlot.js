...
const koyambeduDeliverySlotSchema = new Schema({
  ...
  cutoffTime: { type: String, required: true },  // "10:00" — orders must be placed by this time
...
koyambeduDeliverySlotSchema.statics.seedDefaults = async function() {
  ...
  await this.insertMany([
    { type: 'today',    timeLabel: 'Today  4 PM – 7 PM',      cutoffTime: '10:00', sortOrder: 1 },
    { type: 'today',    timeLabel: 'Today  7 PM – 10 PM',     cutoffTime: '14:00', sortOrder: 2 },
